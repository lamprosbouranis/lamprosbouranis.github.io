...
I worked as a Consultant-Statistician at IQVIA EMEA Real World Methods \& Evidence Generation. 
Previously I held the position of Marie Sklodowska-Curie Research Fellow at the [Department of Statistics](https://www.dept.aueb.gr/en/stat), Athens University of Economics and Business. My research focused on Bayesian inference and model selection for stochastic epidemics under the supervision of [Prof. Nikos Demiris](http://www2.aueb.gr/users/nikos/) and [Prof. Ioannis Ntzoufras](https://www.aueb.gr/en/faculty_page/ntzoufras-ioannis/).
...
My full CV is available [here](Bouranis_CV.pdf) [last update: 17/6/2024].
...
* I joined the IQVIA EMEA Real World Methods \& Evidence Generation team as a Consultant-Statistician.
...
* I presented my work on _Bayesian learning of transmission dynamics using exchangeable Gaussian processes_ at the Greek Stochastics $\nu$' Meeting at Naxos, Greece [7-10 July].
